...
import com.treetotal.android.engine.BackupCrypto
 ...
 * client watches); TreeTotal never sends it anywhere itself.
 *
...
object BackupManager {
    ...
    fun backupFileName(today: LocalDate): String = "treetotal-backup-$today.ttbk"
