...
import com.treetotal.android.engine.Badge
import com.treetotal.android.engine.BadgeCatalog
import com.treetotal.android.engine.BadgeEngine
import com.treetotal.android.engine.DayLedger
import com.treetotal.android.engine.EducationCard
import com.treetotal.android.engine.EducationLibrary
import com.treetotal.android.engine.EncouragementEngine
import com.treetotal.android.engine.HealthMilestone
import com.treetotal.android.engine.HealthTimeline
...
class GamificationManager(context: Context) {
    ...
    fun homeState(): HomeState {
        ...
        val daysToNextBadge = nextBadge
            ?.takeIf { it.kind == com.treetotal.android.engine.BadgeKind.AF_TOTAL || it.kind == com.treetotal.android.engine.BadgeKind.STREAK }
    ...
    private fun treeCelebrations(displayAfDays: Int): List<Badge> {
        ...
        return (1..trees).filter { "tree_$it" !in celebrated }.map { n ->
            ...
            Badge(
                ...
                kind = com.treetotal.android.engine.BadgeKind.AF_TOTAL,
