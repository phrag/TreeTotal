 ...
 * database as the app.
 */
class SobrieTreeWidget : AppWidgetProvider() {

    companion object {
        const val ACTION_LOG_FAVORITE = "com.sobrietree.android.widget.LOG_FAVORITE"
        const val ACTION_UNDO = "com.sobrietree.android.widget.UNDO"
        ...
        fun refresh(context: Context) {
            ...
            val ids = manager.getAppWidgetIds(ComponentName(context, SobrieTreeWidget::class.java))
        ...
        private fun broadcast(context: Context, action: String): PendingIntent =
            PendingIntent.getBroadcast(
                context,
                action.hashCode(),
                Intent(context, SobrieTreeWidget::class.java).setAction(action),
