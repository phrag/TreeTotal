...
import com.sobrietree.android.engine.MetricsEngine
import com.sobrietree.android.engine.SavingsEngine
import com.sobrietree.android.engine.StatsEngine
import com.sobrietree.android.engine.StreakEngine
    ...
    private fun treeCelebrations(displayAfDays: Int): List<Badge> {
        ...
        return (1..trees).filter { "tree_$it" !in celebrated }.map { n ->
            ...
            Badge(
                ...
                kind = com.sobrietree.android.engine.BadgeKind.AF_TOTAL,
